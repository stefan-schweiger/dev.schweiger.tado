declare module 'homey-oauth2app' {
  ...
  export declare class OAuth2Client {
     ...
     * @returns {Promise<*>}
     */
    get({ path, query, headers }: { path: string; query: string; headers: Record<string, string> }): Promise<any>;
    /**
     * @param {object} args
     * @param {string} args.path
     * @param {string} args.query
     ...
     * @returns {Promise<*>}
     */
    delete({ path, query, headers }: { path: string; query: string; headers: Record<string, string> }): Promise<any>;
    /**
     * @param {object} args
     * @param {string} args.path
     * @param {string} args.query
     ...
     * @returns {Promise<null>}
     */
    getTokenByCredentials({ username, password }: { username: string; password: string }): Promise<null>;
    /**
     * @returns {string|null}
     */
     ...
     * @returns {string}
     */
    getAuthorizationUrl({ scopes, state }?: { scopes: string[]; state: string }): string;
    /**
     * @returns {string}
     */
    getTitle(): string;
     ...
     * @returns {Promise<Object>}
     */
    onRequestHeaders({ headers }: { headers: Record<string, string> }): Promise<any>;
    /**
     * @description Can be extended
     ...
     * @returns {Promise<void>}
     */
    onHandleGetTokenByCodeError({ response }: { response: object }): Promise<void>;
    /**
     * @description Can be extended
     * @param {object} args
     * @param {object} args.response
     * @returns {Promise<void>}
     */
    onHandleGetTokenByCodeResponse({ response }: { response: object }): Promise<void>;
    /**
     ...
     * @returns {Promise<OAuth2Token>}
     */
    onGetTokenByCredentials({ username, password }: { username: string; password: string }): Promise<OAuth2Token>;
    onHandleGetTokenByCredentialsError({ response }: { response: any }): Promise<void>;
    onHandleGetTokenByCredentialsResponse({ response }: { response: any }): Promise<any>;
    /**
     ...
     * @returns {Promise<void>}
     */
    onHandleRefreshTokenError({ response }: { response: object }): Promise<void>;
    /**
     * @param {object} args
     * @param {object} args.response
     * @returns {Promise<OAuth2Token>}
     */
    onHandleRefreshTokenResponse({ response }: { response: object }): Promise<OAuth2Token>;
    /**
     * @param {object} args
     * @param args.response
     * @returns {Promise<void>}
     ...
     */
    onShouldRefreshToken({ status }: { status: number }): Promise<boolean>;
    /**
     * @description This method returns a boolean if the response is rate limited
     * @param {object} args
     * @param {number} args.status
     ...
     * @returns {Promise<boolean>}
     */
    onIsRateLimited({ status, headers }: { status: number; headers: Record<string, string> }): Promise<boolean>;
    /**
     ...
     * @returns {string}
     */
    onHandleAuthorizationURL({ scopes, state }?: { scopes: string[]; state: string }): string;
    /**
     ...
     * @returns {*}
     */
    onHandleAuthorizationURLScopes({ scopes }: { scopes: string[] }): string | undefined; /// Assuming string since it uses .join()
    /**
